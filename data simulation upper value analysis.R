...
simRun1<-function(n,beta_right,beta_int,lambda_right,gammas_right,shape_int,scale_int){
	...
	for(i in 1:n){
		dat$y[i]<-min(dat$eventtime[i],dat$u[i])
	}
...
set.seed(654)
nsims<-1000
sim1<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.3,beta_int=-0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim2<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.3,beta_int=-0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim3<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.3,beta_int=0,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim4<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.3,beta_int=0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim5<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.3,beta_int=0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))

sim6<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.15,beta_int=-0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim7<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.15,beta_int=-0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim8<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.15,beta_int=0,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim9<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.15,beta_int=0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim10<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=-0.15,beta_int=0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))

sim11<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0,beta_int=-0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim12<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0,beta_int=-0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim13<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0,beta_int=0,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim14<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0,beta_int=0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim15<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0,beta_int=0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))

sim16<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.15,beta_int=-0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim17<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.15,beta_int=-0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim18<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.15,beta_int=0,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim19<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.15,beta_int=0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim20<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.15,beta_int=0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))

sim21<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.3,beta_int=-0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim22<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.3,beta_int=-0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim23<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.3,beta_int=0,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim24<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.3,beta_int=0.15,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
sim25<-rowMeans(replicate(nsims,simRun1(n=20000,beta_right=0.3,beta_int=0.3,
	lambda_right=0.03,gammas_right=0.6,shape_int=2,scale_int=7)))
...
write.csv(table2,"Simulation N=20000 12Pct Upper 5050 Results.csv")
write.csv(table2a,"Simulation N=20000 12Pct Upper 5050 Results Full.csv")
...
write.csv(table2,"Simulation N=20000 12Pct Upper 7525 Results.csv")
write.csv(table2a,"Simulation N=20000 12Pct Upper 7525 Results Full.csv")
...
write.csv(table2,"Simulation N=20000 12Pct Upper 2575 Results.csv")
write.csv(table2a,"Simulation N=20000 12Pct Upper 2575 Results Full.csv")
